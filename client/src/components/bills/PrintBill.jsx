            ...
            <div className="bill-details">
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                ...
                <div className="text-md text-slate-500 sm:block hidden">
                  <p className="font-bold text-slate-700">Koşullar</p>0 Days
                  <p>Teslim</p>
                  <p>00.00.00</p>
                </div>
              </div>
              ...
              <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                <thead>
                  <tr>
                    ...
                    <th
                      scope="col"
                      className=" w-full py-3.5  text-left text-sm font-normal text-slate-700  md:pl-0 sm:table-cell hidden "
                    >
                      Başlık
                    </th>
                    <th
                      colSpan={4}
                      scope="col"
                      className=" w-full py-3.5  text-left text-sm font-normal text-slate-700  md:pl-0 sm:hidden"
                    >
                      Başlık
                    </th>
                    <th
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal  text-red-600">+{((customer?.subTotal * customer?.tax) / 100).toFixed(2)}₺</span>
                    </th>
                  </tr>
                  <tr>
                    <th
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-slate-700 ">
                        {(((customer?.subTotal * customer?.tax) / 100) + customer?.subTotal).toFixed(2)}₺
                      </span>
                    </th>
                  </tr>
                </tfoot>
