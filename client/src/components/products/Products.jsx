...
const Products = ({ categories, filtered, products, setProducts, search }) => {
  ...
  return (
    <div className="product-wrapper grid gap-4 grid-cols-card">
      ...
      <div
        className="product-item border hover:shadow-lg cursor-pointer transition-all select-none bg-orange-800 flex justify-center items-center hover:opacity-90"
